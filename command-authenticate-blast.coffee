...
class CommandAuthenticateBlast
  parseOptions: =>
    commander
      ...
      .option '-n, --number-of-messages [n]', 'Number of parallel messages per second (defaults to 1)', @parseInt, 10
      .parse process.argv
  ...
  authenticate: (i, callback) =>
    ...
    requestOption =
      ...
      method: 'POST'
      headers:
        username: 'cea58c41-aaa0-46d8-ac9e-2ebc90eeaefe'
        password: 'fc23d79499edec704aa0034538e2b1f588e463ea'
