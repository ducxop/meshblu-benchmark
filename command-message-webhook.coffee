...
class CommandMessageWebhook
  parseOptions: =>
    commander
      .option '-h, --host [host]', 'host to register webhook for (defaults localhost)', '192.168.105.221'
      .option '-p, --port [port]', 'Port to bind to / register webhook for (defaults :9000)', '5222'
